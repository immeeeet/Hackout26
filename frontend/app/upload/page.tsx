...
export default function UploadPage() {
  ...
  const handleUploadAndAnalyze = async () => {
    ...
    try {
      ...
      let defaultMsg = "Error uploading file. Please check column names and try again.";
      if (err.message === "Network Error" || err.code === "ERR_NETWORK") {
        defaultMsg = "Could not connect to the backend server. Please make sure it is running.";
      }
      
      setErrorMessage(
        err.response?.data?.detail || defaultMsg
      );
    }
  };
